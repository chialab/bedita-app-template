...
return [
     ...
     * ## Options
     *
     * - `level` - The minimum status of objects in order for them to be shown. For instance, setting this
     *   to 'draft' will result in objects with statuses either 'on' or 'draft' to be displayed.
     */
    'Status' => [
        'level' => env('STATUS_LEVEL', 'draft'),
    ],
     ...
     */
    'Thumbnails' => [
        'allowAny' => filter_var(env('THUMBNAILS_ALLOW_ANY', true), FILTER_VALIDATE_BOOLEAN),
        'presets' => [
            'ultra' => [
                // 'generator' => 'async',
                'w' => 1344,
